...
CREATE TABLE categories (
    category_id smallint NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE region (
    region_id smallint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE orders (
    ...
    ship_region character varying(30),

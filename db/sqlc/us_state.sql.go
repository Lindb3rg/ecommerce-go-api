...
func (q *Queries) CountStatesByRegion(ctx context.Context) (CountStatesByRegionRow, error) {
	row := q.db.QueryRowContext(ctx, countStatesByRegion)
...
func (q *Queries) CreateState(ctx context.Context, arg CreateStateParams) (UsState, error) {
	row := q.db.QueryRowContext(ctx, createState, arg.StateName, arg.StateAbbr, arg.StateRegion)
	var i UsState
	err := row.Scan(
		&i.EmployeeID,
		&i.StateName,
...
func (q *Queries) DeleteState(ctx context.Context, employeeID int16) error {
	_, err := q.db.ExecContext(ctx, deleteState, employeeID)
	return err
}
...
func (q *Queries) GetState(ctx context.Context, employeeID int16) (UsState, error) {
	row := q.db.QueryRowContext(ctx, getState, employeeID)
	var i UsState
	err := row.Scan(
		&i.EmployeeID,
		&i.StateName,
...
func (q *Queries) GetStateByAbbreviation(ctx context.Context, stateAbbr sql.NullString) (UsState, error) {
	row := q.db.QueryRowContext(ctx, getStateByAbbreviation, stateAbbr)
	var i UsState
	err := row.Scan(
		&i.EmployeeID,
		&i.StateName,
...
func (q *Queries) GetStatesByRegion(ctx context.Context, stateRegion sql.NullString) ([]UsState, error) {
	rows, err := q.db.QueryContext(ctx, getStatesByRegion, stateRegion)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListStates(ctx context.Context, dollar_1 string) ([]UsState, error) {
	rows, err := q.db.QueryContext(ctx, listStates, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) UpdateState(ctx context.Context, arg UpdateStateParams) (UsState, error) {
	row := q.db.QueryRowContext(ctx, updateState,
		arg.EmployeeID,
		arg.StateName,
		arg.StateAbbr,
		arg.StateRegion,
